...
class ServerRegistry {
  ...
  getServerList() {
    return Object.values(this.servers).map(server => ({
      ...
      // Include countdown and timer information for clients
      restartCountdown: server.metadata.restartCountdown || null,
      matchTimeRemaining: server.metadata.matchTimeRemaining || null
    }));
  }
