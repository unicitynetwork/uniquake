...
class MasterServer {
  ...
  initializeComponents() {
    ...
    this.gameServerManager = new GameServerManager({
      ...
      basePort: this.config.gameServerBasePort || 27961,
      maxConcurrentServers: this.config.maxGameServers || 10,
      masterServerHost: this.config.publicHostname || 'localhost',
      masterServerPort: this.config.port || 27950,
      ...
      gameServerIP: this.config.gameServerIP || 'localhost'
    });
