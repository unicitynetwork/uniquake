...
(function(window) {
  ...
  class BrowserMockServer {
    ...
    async createGameStateToken(broadcast = true) {
      ...
      try {
        // Get game state from game instance if available
        if (this.gameInstance && this.gameInstance.gameState) {
          // Sync with game instance's frame
          this.serverState.gameState.timestamp = this.gameInstance.gameState.timestamp;
          this.serverState.gameState.frame = this.gameInstance.gameState.frame;
          this.serverState.gameState.gameId = this.gameInstance.gameState.gameId;
        } else {
