        ...
        case 'game:state:token':
          ...
          try {
            ...
            if (this.gameIntegration && this.gameIntegration.game) {
              ...
              this.gameIntegration.game.state.frame = serverFrame;
              ...
              this.gameIntegration.game.state.serverHash = result.stateHash || null;
              
              this.log(`Synchronized game state with server frame: ${serverFrame}`);
              
              // Trigger a game state update to refresh UI
              this.gameIntegration.onGameStateChange(this.gameIntegration.game.state);
            }
